"""
Add hcl_demand table
"""
from alembic import op
import sqlalchemy as sa

# revision identifiers, used by Alembic.
revision = "20260301_0003_hcl_demand"
down_revision = "20260301_0002_customer_requirement"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        "hcl_demand",
        sa.Column("demand_id", sa.String(length=128), primary_key=True),
        sa.Column(
