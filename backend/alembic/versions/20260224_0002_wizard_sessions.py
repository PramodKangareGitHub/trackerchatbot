"""
Alembic migration for wizard_sessions table
"""
from alembic import op
import sqlalchemy as sa

# revision identifiers, used by Alembic.
revision = "20260224_0002_wizard_sessions"
down_revision = "20260224_0001_job_posting_sequences"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    if not inspector.has_table('wizard_sessions'):
        op.create_table(
            ...
            # Foreign keys will be added after related tables exist
        )
